...
# IMPORTING DATASET
data = pd.read_csv(r"C:\Users\seema\OneDrive\Desktop\COURSE\360DigiTMG Course\Data Science_03052023_10AM(20032023)\Module 5-c.Simple Linear Regression\Assignment\SLR_key\delivery_time.csv")
...
plt.hist(data['Sorting_Time']) #histogram
...
imp = preprocessor.fit(X)

joblib.dump(imp, 'imp')

data['Sorting_Time'] = imp.transform(X)
