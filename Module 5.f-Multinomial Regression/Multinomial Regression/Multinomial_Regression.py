...
mode = pd.read_csv(r"C:\Users\seema\OneDrive\Desktop\COURSE\360DigiTMG Course\Data Science_03052023_10AM(20032023)\Module 5.f-Multinomial Regression\Multinomial Regression\mode.csv")
mode.head(10)
mode.describe()
...
engine = create_engine("mysql+pymysql://{user}:{pw}@localhost/{db}"
                       .format(user = "root",    # user
                               ...
                               db = "multi_db")) # database


# Load the offline data into Database to simulate client conditions

mode.to_sql('multi', con = engine, if_exists = 'replace', chunksize = 1000, index= False)
...
mode = pd.read_sql_query(sql, engine).convert_dtypes()
...
data = pd.read_excel(r"C:\Users\seema\OneDrive\Desktop\COURSE\360DigiTMG Course\Data Science_03052023_10AM(20032023)\Module 5.f-Multinomial Regression\Multinomial Regression\mode_test.xlsx")
