...
claims = pd.read_csv(r"C:\Users\seema\OneDrive\Desktop\COURSE\360DigiTMG Course\Data Science_03052023_10AM(20032023)\Module 5.e-Logistic Regression\logistic regresssion\claimants.csv").convert_dtypes()
claims.info()
...
# Load the new data
data = pd.read_excel(r"C:\Users\seema\OneDrive\Desktop\COURSE\360DigiTMG Course\Data Science_03052023_10AM(20032023)\Module 5.e-Logistic Regression\logistic regresssion\claims_test.xlsx").convert_dtypes()
