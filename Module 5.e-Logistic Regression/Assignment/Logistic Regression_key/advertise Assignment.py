...
engine = create_engine("mysql+pymysql://{user}:{pw}@localhost/{db}"
                       .format(user = "root",    # user
                               ...
                               db = "advertise_db")) # database

# Load the offline data into Database 
adver = pd.read_csv(r"C:\Users\seema\OneDrive\Desktop\COURSE\360DigiTMG Course\Data Science_03052023_10AM(20032023)\Module 5.e-Logistic Regression\Assignment\Logistic Regression_key\advertising.csv")
adver.info()
